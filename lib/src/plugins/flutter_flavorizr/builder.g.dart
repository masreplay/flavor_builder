...
_$FlutterFlavorizrImpl _$$FlutterFlavorizrImplFromJson(
    ...
    _$FlutterFlavorizrImpl(
      ...
      macos: FlavorizrMacos.fromJson(json['macos'] as Map<String, dynamic>),
    );
...
_$FlavorizrMacosImpl _$$FlavorizrMacosImplFromJson(Map<String, dynamic> json) =>
    _$FlavorizrMacosImpl(
      bundleId: json['bundleId'] as String,
      icon: json['icon'] as String,
      variables: (json['variables'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
...
Map<String, dynamic> _$$FlavorizrMacosImplToJson(
        _$FlavorizrMacosImpl instance) =>
    <String, dynamic>{
      'bundleId': instance.bundleId,
      'icon': instance.icon,
      'variables': instance.variables,
